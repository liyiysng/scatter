...
import (
	...
	"github.com/liyiysng/scatter/util/timex"
...
const (
	// p2cName is the name of p2c balancer.
	p2cName = "p2c_ewma"
...
func newP2CBuilder() balancer.Builder {
	return base.NewBalancerBuilder(p2cName, &p2cPickerBuilder{}, base.Config{HealthCheck: false})
}
...
func (p *p2cPicker) Pick(info balancer.PickInfo) (res balancer.PickResult, err error) {
	p.lock.Lock()
	defer p.lock.Unlock()
...
func (p *p2cPicker) buildDoneFunc(c *subConn) func(info balancer.DoneInfo) {
	...
	return func(info balancer.DoneInfo) {
		...
		success := initSuccess
		if info.Err != nil && !ErrorAcceptable(info.Err) {
			success = 0
		}
...
func (p *p2cPicker) logStats() {
	...
	myLog.Infof("p2c - %s", strings.Join(stats, "; "))
}
