...
func (c *cache) run() {
	...
	for {
		...
		if err != nil {
			...
			if a > 3 {
				myLog.Warning("rcache: ", err, " backing off ", d)
				a = 0
			}
...
func (c *cache) GetService(service string, opts ...GetOption) ([]*Service, error) {
	// get the service
...
func New(r Registry, opts ...CacheOption) Cache {
